...
class CharacterDataLatin1 extends CharacterData {
    ...
    int getProperties(int ch) {
    	System.out.println("%%%%%%%%%%%%%%%%%%%%getProperties was called!!!This should never happen%%%%%%%%%%%%%%%%%");
    	assert false : "This is highly inefficient! Should never call java.lang.CharacterDataLatin1.getProperties(int ch)";
		char offset = (char)ch;
        int props = A[offset];
        return props;
    }
    ...
    */
    int toLowerCase(int ch) {
    	// we assume we only want to work with alphabet chars here
    	if (ch >= 'A'&& ch <= 'Z') {
    		return ch + 32;
    	}
    	else
    ...
    */
    ...
    boolean isWhitespace(int ch) {
    	return (ch == 32); //ignores 12 and 13, not sure what the case is with 14 anyways
    	//return (ch == 12 ||ch == 13 || ch == 14);
    }
    /*
    boolean isWhitespace(int ch) {
        int props = getProperties(ch);
