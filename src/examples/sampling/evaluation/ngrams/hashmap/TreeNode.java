...
final class TreeNode<K, V> extends Node<K, V>
{
        ...
        for (TreeNode<K, V> x = this; x != null; x = next) {
            ...
            if (root == null) {
                ...
                do {
                    ...
                    else if ((kc == null && (kc = this.comparableClassFor(k)) == null) || (dir = this.compareComparables(kc, k, pk)) == conditionObj1.getValue()) {
    ...
    private final void splitHelper(final int bit, final int index, final Node<K, V>[] tab) {
